...
void SetupRC(void)
{
	...
	ADSTextureShader = shaderManager.LoadShaderPairWithAttributes("LitTexture.vp", "LitTexture.fp", 3, GLT_ATTRIBUTE_VERTEX, "vVertex", GLT_ATTRIBUTE_NORMAL, "vNormal", GLT_ATTRIBUTE_TEXTURE0, "vTexture0");//忘记指定上阶段要传的atrributer，导致纹理相关的操作没有响应
